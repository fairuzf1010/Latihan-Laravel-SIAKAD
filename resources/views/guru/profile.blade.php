                        ...
                        <div class="card-title mb-4">
                            <div class="d-flex justify-content-start">
                                <div class="image-container">
                                    <img src="" id="imgProfile" style="width: 100px; height: 100px;" class="img-thumbnail" />
                                    <div class="middle">
                                    <a href="" class = "btn btn-info btn-sm" > Ubah Profile</a>
                                       
                                    </div>
                                </div>
                                <div class="userData ml-3">
                                    <h2 class="d-block" style="font-size: 1.5rem; font-weight: bold"><a href="javascript:void(0);">{{$guru->nama}}</a></h2>
