...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>MechTech IDN 2020</title>
        <link rel="shortcut icon" href="{{ ('gambar/logo-baru.png') }}">
...
.jumbotron {
    background-image:url("gambar/working.png");
...
@supports (-ms-ime-align: auto) {
  ...
  <a class="navbar-brand" href="#" id = "gambar0"> <img src="{{ ('gambar/logo-baru.png ') }}" id = "gambar1">   </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    color:white;" class="clock" onload="showTime()"></div> </a></li>
      ...
      <div class="container">
        ...
        <center><h2 style = "color:white;"> AYO, MULAILAH BANGUN KARIR ANDA DI SINI </h2></center> 
          ...
          <div class="col-sm-12 col-md-6">
            <h6>About</h6>
            <p class="text-justify">MechTech Merupakan salah satu Platform pembelajaran <br> untuk persiapan di dunia industri yang sangat disarankan.</p>
          </div>
